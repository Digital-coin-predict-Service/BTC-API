...
def coin_prediction(coin_name):
    if coin_name == 'BTC' :
        ...
        result = np.append(scaler.inverse_transform(price[-20:]) * 10000, prediction)

        return result.flatten()

    if coin_name == 'ETH':
        x_step = 100  # length of train_x of each time step
        dividing = 10000
